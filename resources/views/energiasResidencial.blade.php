...
<main role="main"> 
      ...
      <div class="margin2x">
        <div class="s-12 m-6 l-4 margin-bottom-60">
          ...
          <div class="margin-left-60">
            <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Información General</h3>
        ...
        <div class="s-12 m-6 l-4 margin-bottom-60">
          ...
          <div class="margin-left-60">
            <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Visita y Anteproyecto</h3>
            <p>Hendrerit in vulputate duis autem vel eum iriure dolor in velit esse molestie consequat, vel illum dolore nulla facilisis</p>
            <!-- <a class="text-more-info text-primary" href="/">Read more</a>  -->               
          </div>
        </div>
        <div class="s-12 m-6 l-4 margin-bottom-60">
          ...
          <div class="margin-left-60">
            <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Proyecto Ejecutivo</h3>
            <p>Hendrerit in vulputate duis autem vel eum iriure dolor in velit esse molestie consequat, vel illum dolore nulla facilisis</p>
            <!-- <a class="text-more-info text-primary" href="/">Read more</a> -->                 
          </div>
        </div>
        <div class="s-12 m-6 l-4 margin-m-bottom-60">
          ...
          <div class="margin-left-60">
            <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Instalación</h3>
            <p>Hendrerit in vulputate duis autem vel eum iriure dolor in velit esse molestie consequat, vel illum dolore nulla facilisis</p>
            <!-- <a class="text-more-info text-primary" href="/">Read more</a> -->                 
          </div>
        </div>
        <div class="s-12 m-6 l-4 margin-m-bottom-60">
          ...
          <div class="margin-left-60">
            <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Puesta a Punto</h3>
            <p>Hendrerit in vulputate duis autem vel eum iriure dolor in velit esse molestie consequat, vel illum dolore nulla facilisis</p>
            <!-- <a class="text-more-info text-primary" href="/">Read more</a> -->                 
          </div>
        </div>
        <div class="s-12 m-6 l-4 margin-m-bottom-60">
          ...
          <div class="margin-left-60">
            <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Rendimiento</h3>
            <p>Hendrerit in vulputate duis autem vel eum iriure dolor in velit esse molestie consequat, vel illum dolore nulla facilisis</p>
            <!-- <a class="text-more-info text-primary" href="/">Read more</a>  -->                
          </div>
        </div>
  ...
  <section class="background-primary full-width">        
    <div class="m-12 l-6 xl-5 xxl-4">
      <img class="full-img" src="img/adobe/residencial_002.jpeg"/>
    </div>         
