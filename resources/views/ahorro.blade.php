        ...
        <div class="margin2x">
          <div class="m-12 l-6 margin-bottom-60">
            <div class="float-left">
              <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Nuestros Costos</h3>
              <p>
                Sabemos que la instalación de uns istema fotovoltáico es una inversión y no queremos descapitalizarte, por lo que te ofrecemos 
                diferentes alternativas de pago.
                <p class="text-padding-small background-primary text-white s-12 margin-top-bottom-20">Opciones de Pago</p>                    
          ...
          <div class="m-12 l-6 margin-bottom-60">
            <div class="float-left">
              <h3 class="text-strong text-size-20 text-line-height-1 margin-bottom-20">Nuestras Ventajas</h3>
              <p>
