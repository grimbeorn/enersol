...
<main role="main">   
  ...
  <header class="section background-image text-center" style="background-image:url(img/reducido/industrial02.jpg)">
    <h1 class="animated-element slow text-extra-thin text-white text-s-size-30 text-m-size-40 text-size-50 text-line-height-1 margin-bottom-30 margin-top-130">
      FOTOVOLTÁICO INDUSTRIAL
    </h1>
    <p class="animated-element text-white">Expertos en Instalaciones Industriales</p>
    ...
    <div class="line text-center">
      ...
      <h2 class="text-dark text-size-50 text-m-size-40">Instalaciones <b>Industriales</b></h2>
  ...
  <section class="background-primary full-width">         
    <div class="m-12 l-6 xl-7 xxl-8">
      <div class="l-12 xl-11 xxl-8 padding-2x">
        ...
        <p class="margin-bottom">Las instalaciones fotovoltáicas en régimen de autoconsumo industrial permiten reducir la  facturación mensual de forma drástica, llegando a consumos nulos.
          El sistema estructural sobre el que se desplanta el sistema fotovoltáico, permite la colocación de los paneles de forma rápida y sin dañar la estructura primaria del inmueble.
    ...
    <div class="m-12 l-6 xl-5 xxl-4">
      <img class="full-img" src="img/reducido/industrial02_002.jpg"/>
    </div>
  </section>
